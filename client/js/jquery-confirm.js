...
(function ($) {
    ...
    Jconfirm.prototype = {
        ...
        _buildHTML: function () {
            ...
            if (this.confirmButton) {
                ...
                this.$confirmButton[0].name    =   this.confirmButtonName;
            }
            if (this.cancelButton && this.type !== 'alert') {
                ...
                this.$cancelButton[0].name =   this.cancelButtonName; 
            }
            if (this.autoClose)
    ...
    jconfirm.pluginDefaults = {
        type: 'alert',
        template: '<div class="jconfirm"><div class="jconfirm-bg"></div><div class="jalertcontainer container"><div class="row"><div class="col-md-4 col-md-offset-4"><div class="jconfirm-box"><div class="title"></div><div class="content"></div><div class="buttons pull-right"></div><div class="jquery-clear"></div></div></div></div></div></div>',
        title: 'Hello',
